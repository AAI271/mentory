        ...
        <footer>
            <div className="footer__container marginX">
                <div className="footer__info">
                    ...
                    <p><InertiaLink href="lessons/Data_Analysis">Data Analysis</InertiaLink></p>
                    <p><InertiaLink href="lessons/C_Sharp">C#</InertiaLink></p>
                    <p><InertiaLink href="lessons/Frontend">Frontend</InertiaLink></p>
                    <p><InertiaLink href="lessons/QA_Engineering">QA_Engineering</InertiaLink></p>
                </div>
